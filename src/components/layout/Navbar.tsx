        ...
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          >
            ...
            <div>
              ...
              <span className="text-[9px] text-text-muted font-mono tracking-widest uppercase block mt-0.5 group-hover:text-brand-light/80 transition-colors duration-300">
                PRACTICE EMR
              </span>
            </div>
          </Link>
