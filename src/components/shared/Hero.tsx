      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            >
              Focus on <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-light to-accent">therapy</span>. Not paperwork.
            </motion.h1>
            ...
            >
              ...
              <Link to="/contact">
                <Button variant="secondary" size="lg" className="w-full hover:border-brand">
                  Book a Demo
                </Button>
              </Link>
            </motion.div>
          ...
          >
            ...
            <div className="w-[576px] shrink-0 flex justify-center origin-top scale-[0.55] sm:scale-[0.8] lg:scale-[0.95] xl:scale-[1.1] 2xl:scale-[1.15] -mb-[200px] sm:-mb-[90px] lg:mb-0">
              ...
              <motion.div
                ...
                className="w-[576px] shrink-0 max-w-none relative bg-surface/90 border border-brand/30 rounded-2xl shadow-[var(--shadow-glow)] overflow-visible transform-gpu"
              >
              {/* EMR Mockup Header */}
              <div className="bg-surface rounded-t-2xl border-b border-brand/20 pt-[10px] pb-[10px] pl-[15px] pr-[15px] flex items-center justify-between relative">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] leading-[14.5px] font-mono text-brand-light ml-2 hidden min-[440px]:inline">happyclinic.therapy.ke</span>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left flex flex-col justify-center leading-none">
                    ...
                    <span className="text-[8px] text-brand-light/80 font-medium mt-1 hidden min-[400px]:flex items-center gap-1 leading-[8px]">
              ...
              <div className="grid grid-cols-12 text-left">
                {/* Mockup Sidenav */}
                <div className="col-span-3 border-r border-brand/20 p-2.5 bg-background flex flex-col justify-between text-[11px]">
                  <div>
                    ...
                    {/* Selected "Overview" */}
                    <div className="bg-brand-light/15 text-brand-light border border-brand-light/15 rounded-md px-2 py-1.2 flex items-center gap-1.5 mb-3.5 font-bold cursor-pointer transition-all">
                      <Activity className="w-4 h-4 text-brand-light shrink-0" />
                      <span className="text-[8.2px]">Overview</span>
                    </div>

                    {/* Section 1: CARE DELIVERY */}
                    <div className="text-[6.8px] font-black text-brand-light/60 uppercase tracking-widest pl-1.5 mb-1.5">
                      Care Delivery
                    </div>
                    <ul className="space-y-0.8 text-text-muted font-bold mb-4">
                      <li className="px-1.5 py-1 hover:bg-white/5 hover:text-white rounded-md flex items-center gap-1.5 transition-colors cursor-pointer text-[8.2px]">
                        <Calendar className="w-4 h-4 text-brand-light/80 shrink-0" />
                        <span>My Calendar</span>
                      </li>
                      <li className="px-1.5 py-1 hover:bg-white/5 hover:text-white rounded-md flex items-center gap-1.5 transition-colors cursor-pointer text-[8.2px]">
                        <List className="w-4 h-4 text-brand-light/80 shrink-0" />
                        <span>All Bookings</span>
                      </li>
                      <li className="px-1.5 py-1 hover:bg-white/5 hover:text-white rounded-md flex items-center gap-1.5 transition-colors cursor-pointer text-[8.2px]">
                        <Users className="w-4 h-4 text-brand-light/80 shrink-0" />
                    ...
                    <ul className="space-y-0.8 text-text-muted font-bold">
                      <li className="px-1.5 py-1 hover:bg-white/5 hover:text-white rounded-md flex items-center gap-1.5 transition-colors cursor-pointer text-[8.2px]">
                        <User className="w-4 h-4 text-brand-light/80 shrink-0" />
                        <span>My Profile</span>
                      </li>
                      <li className="px-1.5 py-1 hover:bg-white/5 hover:text-white rounded-md flex items-center gap-1.5 transition-colors cursor-pointer text-[8.2px]">
                        <Clock className="w-4 h-4 text-brand-light/80 shrink-0" />
                  ...
                  <div className="border-t border-brand/20 pt-2 shrink-0 mt-4">
                    {/* Settings Option from the uploaded view */}
                    <div className="px-1.5 py-1 hover:bg-white/5 hover:text-white rounded-md flex items-center gap-1.5 transition-colors cursor-pointer text-[8.2px] text-text-muted font-bold mb-2">
                      <Settings className="w-4 h-4 text-brand-light/80 shrink-0" />
                      <span>Settings</span>
                    </div>

                    {/* Therapist Profile Badge */}
                    <div className="flex items-center gap-1.5 p-1 rounded-lg bg-brand/20 border border-brand/15 mb-2 shrink-0">
                      <img src="https://images.unsplash.com/photo-1607746882042-944635dfe10e?auto=format&fit=crop&q=80&w=48" alt="Dr. Mary Jane" className="w-[14px] h-[14px] rounded-full object-cover border border-brand-light/20" referrerPolicy="no-referrer" />
                      <div className="leading-none text-[6.5px]">
                        ...
                        <span className="text-text-muted block text-[7.5px] leading-[7.5px] mt-0.5 font-medium">Therapist - HC26TH-001</span>
                      </div>
                    </div>

                    {/* Sign Out Button */}
                    <div className="px-1.5 py-1 bg-brand/30 border border-brand/40 rounded-lg flex items-center justify-center gap-1 text-center text-text-muted font-bold hover:text-white cursor-pointer hover:bg-brand/40 transition-all text-[7.5px]">
                      <LogOut className="w-2.5 h-2.5 text-brand-light shrink-0" />
                      <span>Sign Out</span>
                    </div>
                  </div>
                </div>
                ...
                {/* Mockup Main Panel */}
                <div className="col-span-9 p-4 text-gray-200 bg-background/45 flex flex-col gap-3.5 min-h-0">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      <button className="px-1.5 py-0.5 rounded text-[6.5px] font-black bg-brand text-white shadow-xs">This Month</button>
                      <button className="px-1.5 py-0.5 rounded text-[6.5px] font-semibold border border-brand/20 bg-brand/30 text-brand-light hover:text-white transition-all">This Year</button>
                      <button className="px-1.5 py-0.5 rounded text-[6.5px] font-semibold border border-brand/20 bg-brand/30 text-brand-light hover:text-white transition-all">Custom Range</button>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    ...
                    <div 
                      ...
                      className="bg-surface/85 border border-brand/20 rounded-lg p-2 flex items-center justify-between hover:border-brand/30 transition-all cursor-default select-none group"
                    >
                      <div className="text-left">
                        <span className="text-[6.5px] font-bold text-text-muted block tracking-wide">Total Appointments</span>
                      ...
                      <div className="w-5 h-5 rounded-md bg-brand/20 border border-brand/20 flex items-center justify-center shrink-0 ml-1 group-hover:border-brand/30 transition-colors">
                        <Calendar className="w-2.8 h-2.8 text-brand-light" />
                      </div>
                    </div>
                    ...
                    >
                      <div className="text-left">
                        <span className="text-[6.5px] font-bold text-text-muted block tracking-wide">Active Clients</span>
                        <span className="text-sm font-black text-white mt-0.5 block leading-none">
                      ...
                      <div className="w-5 h-5 rounded-md bg-brand/20 border border-brand/20 flex items-center justify-center shrink-0 ml-1 group-hover:border-brand/30 transition-colors">
                        <Users className="w-2.8 h-2.8 text-brand-light" />
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div className="w-5 h-5 rounded-md bg-brand/20 border border-brand/20 flex items-center justify-center shrink-0 ml-1 group-hover:border-emerald-700/60 transition-colors">
                    ...
                    >
                      <div className="text-left">
                        <span className="text-[6.5px] font-bold text-text-muted block tracking-wide">Completion Rate</span>
                        <span className="text-sm font-black text-white mt-0.5 block leading-none">
                      ...
                      <div className="w-5 h-5 rounded-md bg-brand/20 border border-brand/20 flex items-center justify-center shrink-0 ml-1 group-hover:border-brand/30 transition-colors">
                        <Activity className="w-2.8 h-2.8 text-brand-light" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2.5">
                    ...
                    >
                      ...
                      <span className="text-[6px] text-brand-light block mt-0.2 mb-2 font-medium">Sessions per day of week</span>
                      
                      {/* Bar columns */}
                      <div className="flex items-end justify-between h-[34px] pt-1 px-0.5 border-b border-brand/20 pb-1 relative">
                        {[
                          ...
                          <div key={bar.day} className="flex flex-col items-center flex-1">
                            ...
                            <span className="text-[5px] font-bold text-text-muted mt-1 leading-none">{bar.day}</span>
                          </div>
                        ))}
                      </div>
                    </motion.div>
                    ...
                    >
                      <div>
                        ...
                        <span className="text-[6px] text-brand-light block mt-0.2 font-medium">Status distribution</span>
                      </div>
                      ...
                      <div className="flex items-center justify-center p-1.5 relative my-1">
                        ...
                        <div className="absolute text-center">
                          ...
                          <span className="text-[4px] font-bold text-brand-light uppercase block leading-none mt-0.2">Total</span>
                        </div>
                      </div>
                    ...
                    >
                      <div>
                        ...
                        <span className="text-[6px] text-brand-light block mt-0.2 font-medium">Virtual vs in-Person</span>
                      </div>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    ...
                    <div className="bg-surface/70 border border-brand/20 rounded-xl p-2 text-left">
                      <div className="flex justify-between items-center mb-1.5 pb-0.8 border-b border-brand/20">
                        ...
                        <span className="text-[6.5px] font-bold text-brand-light font-mono">6/16/2026</span>
                      </div>
                      <div className="space-y-1">
                        {/* 12:00 Jane Doe */}
                        <div className="flex items-center justify-between p-1 bg-brand/15 border border-brand/15 rounded">
                          <div className="flex items-center gap-1.2">
                            <span className="text-[6.5px] font-bold font-mono text-brand-light bg-brand/30 px-0.8 py-0.1 rounded border border-brand/10 shrink-0">12:00</span>
                            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=48" alt="Jane" className="w-[10px] h-[10px] rounded-full object-cover border-[0.5px] border-brand-light/20" referrerPolicy="no-referrer" />
                            <div className="leading-none">
                              <span className="text-[7px] font-extrabold text-white block">Jane Doe</span>
                              <span className="text-[5.5px] text-text-muted block">Appointment time</span>
                            </div>
                          </div>
                        </div>
                        {/* 13:00 John Smith */}
                        <div className="flex items-center justify-between p-1 bg-brand/15 border border-brand/15 rounded">
                          <div className="flex items-center gap-1.2">
                            <span className="text-[6.5px] font-bold font-mono text-brand-light bg-brand/30 px-0.8 py-0.1 rounded border border-brand/10 shrink-0">13:00</span>
                            <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=48" alt="John" className="w-[10px] h-[10px] rounded-full object-cover border-[0.5px] border-brand-light/20" referrerPolicy="no-referrer" />
                            <div className="leading-none">
                        ...
                        <div className="flex items-center justify-between p-1 bg-brand/15 border border-brand/15 rounded">
                          <div className="flex items-center gap-1.2">
                            <span className="text-[6.5px] font-bold font-mono text-brand-light bg-brand/30 px-0.8 py-0.1 rounded border border-brand/10 shrink-0">14:00</span>
                            <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=48" alt="Sarah" className="w-[10px] h-[10px] rounded-full object-cover border-[0.5px] border-brand-light/20" referrerPolicy="no-referrer" />
                            <div className="leading-none">
                    ...
                    <div className="bg-surface/70 border border-brand/20 rounded-xl p-2 text-left">
                      ...
                      <div className="space-y-1">
                        {/* Jane Doe Booking */}
                        <div className="flex items-center justify-between p-1 bg-brand/10 border border-brand/10 rounded">
                          <div className="flex items-center gap-1.2">
                            <span className="w-4 h-4 rounded-full bg-brand/30 border border-brand/20 text-brand-light flex items-center justify-center text-[6px] font-black shrink-0">JS</span>
                            <div className="leading-none">
                              <span className="text-[7px] font-extrabold text-white block">Jane Doe</span>
                              <span className="text-[5.5px] text-text-muted block">Completed booking</span>
                            </div>
                          </div>
                        ...
                        <div className="flex items-center justify-between p-1 bg-brand/10 border border-brand/10 rounded">
                          <div className="flex items-center gap-1.2">
                            <span className="w-4 h-4 rounded-full bg-brand/30 border border-brand/20 text-brand-light flex items-center justify-center text-[6px] font-black shrink-0">MC</span>
                            <div className="leading-none">
