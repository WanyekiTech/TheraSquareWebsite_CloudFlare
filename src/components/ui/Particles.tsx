...
export const Particles: React.FC<ParticlesProps> = ({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      // Calculate based on window, guaranteeing responsiveness regardless of z-index
    ...
    return () => {
      ...
      // Explicitly lose context to prevent React 18 Strict Mode memory leaks
  ...
  return <div ref={containerRef} className={`absolute inset-0 w-full h-full pointer-events-none ${className}`} />;
};
